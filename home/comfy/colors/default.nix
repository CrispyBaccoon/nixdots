    ...
    in
    {
      ...
      qutebrowser = {
        ...
        settings = {
          ...
          url.default_page = "file:///home/comfy/documents/project/startpage/index.html";
          url.start_pages = "file:///home/comfy/documents/project/startpage/index.html";
          url.searchengines = {
